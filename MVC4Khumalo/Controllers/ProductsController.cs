...
namespace MVC4Khumalo.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Price,Category,Quantity,ImageUrl")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Price,Category,Quantity,ImageUrl")] Product product)
        {
            if (id != product.Id)
            {
                return NotFound();
